  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? 'bg-[#263d67] shadow-md' : 'bg-[#263d67]/95'
      }`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-white hover:text-[#7fb3ff] transition-colors font-medium"
            >
              Início
            </button>
            <button
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="md:hidden text-white hover:text-[#7fb3ff] transition-colors p-2"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-white/10 pt-4">
            <div className="flex flex-col space-y-3">
              <button
                onClick={() => scrollToSection('inicio')}
                className="text-white hover:text-[#7fb3ff] transition-colors font-medium text-left py-2"
              >
                Início
              </button>
              <button
