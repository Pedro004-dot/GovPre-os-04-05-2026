        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden">
              <div className="bg-gradient-to-br from-[#00397b] via-[#00397b] to-[#00853c] p-12">
                <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-40"></div>

                <div className="relative space-y-8">
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 transform hover:scale-105 transition-all duration-300">
                    <div className="flex items-center space-x-6">
                      <div className="bg-gradient-to-br from-[#00853c] to-[#006d30] rounded-2xl w-16 h-16 flex items-center justify-center font-bold text-white text-2xl flex-shrink-0 shadow-lg">
                        1
                      </div>
                      <div className="flex-1">
                        <div className="text-white font-bold text-xl mb-3">Dados Coletados</div>
                        ...
                        <p className="text-white/80 text-sm mt-2">Processando milhares de licitações</p>
                      </div>
                    </div>
                  </div>

                  <div className="flex justify-center">
                    <div className="w-1 h-12 bg-gradient-to-b from-white/30 to-white/10 rounded-full"></div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 transform hover:scale-105 transition-all duration-300">
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="flex-1">
                        <div className="text-white font-bold text-xl mb-3">Saneamento Aplicado</div>
                        <div className="w-full bg-white/10 rounded-full h-3 overflow-hidden">
                          <div className="bg-gradient-to-r from-[#00853c] to-[#00d46a] h-3 rounded-full animate-pulse shadow-lg" style={{ width: '85%' }}></div>
                        </div>
                        <p className="text-white/80 text-sm mt-2">Filtrando dados inconsistentes</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 transform hover:scale-105 transition-all duration-300">
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="flex-1">
                        <div className="text-white font-bold text-xl mb-3">Validação Concluída</div>
                        <div className="w-full bg-white/10 rounded-full h-3 overflow-hidden">
                          <div className="bg-gradient-to-r from-[#00853c] to-[#00d46a] h-3 rounded-full animate-pulse shadow-lg" style={{ width: '100%' }}></div>
                        </div>
                        <p className="text-white/80 text-sm mt-2">Análise técnica finalizada</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-1 pt-2">
                      <div className="flex items-center space-x-4 mb-3">
                        <div className="bg-gradient-to-br from-[#00397b] to-[#00853c] rounded-xl p-3">
